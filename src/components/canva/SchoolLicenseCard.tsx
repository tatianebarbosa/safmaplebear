...
import { getNonComplianceReason as getEmailNonComplianceReason } from '@/lib/validators';
...
export const SchoolLicenseCard = ({ 
  ...
  const getNonComplianceReason = (email: string) => getEmailNonComplianceReason(email);
