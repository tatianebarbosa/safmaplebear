...
const KnowledgeBasePage = () => {
  ...
  const quickstartItems = [
    ...
    },
    {
      ...
      description: "Crie prompts curtos na aba de Prompts da IA para definir tom de voz e respostas rpidas.",
        ...
        <CardHeader className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <CardDescription>
                Use esta pgina para estruturar o contedo do link "Base de Conhecimento" no header e alimentar a IA.
              </CardDescription>
            </div>
          </div>
        ...
        <CardContent className="space-y-4">
          <div className="grid gap-3 sm:grid-cols-3">
            ...
            <div className="rounded-xl border bg-white p-4 shadow-sm">
              ...
              <p className="text-xs text-muted-foreground">Organize por mdulo ou tipo de contedo</p>
            </div>
            <div className="rounded-xl border bg-white p-4 shadow-sm">
              <p className="text-sm text-muted-foreground">Prompts da IA</p>
              <p className="text-2xl font-semibold">{stats.prompts}</p>
              <p className="text-xs text-muted-foreground">Tom de voz e respostas rpidas do assistente</p>
            </div>
          </div>
